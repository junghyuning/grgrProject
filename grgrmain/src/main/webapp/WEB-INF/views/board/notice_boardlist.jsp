				...
				<ul class="row portfolio project-grid lightbox list-unstyled mb-0"
					...
					<c:forEach items="${noticeBoardList}" var="noticeBoard">
						<li class="col-md-12 col-lg-0 project"
							><a
							href="<c:url value='/noticeboard/read${pager.searchCondition.getQueryString()}&noticeBno=${noticeBoard.noticeBno}'/>">
								<!-- &pageNum=${pageNum} -->
								<div class="promo-box">
									<div class="cta p-0">
										<div class="row v-center">
											...
											<div class="col-lg-12 text-left tablet-lg-center">
												<p class="mb-20">${noticeBoard.noticeTitle}</p>
												<p class="lead mb-20">${noticeBoard.noticeContent}&nbsp;&nbsp;...</p>
		...
		<ul class="pagination justify-content-center">
			...
			<c:choose>
				<c:when test="${pager.startPage != 1 }">
					<li class="page-item"><a class="page-link"
						href="<c:url value='/noticeboard/list${pager.searchCondition.getQueryString(pager.startPage-1)}'/>"><i
				...
				<c:choose>
					<c:when test="${i == pager.searchCondition.pageNum}">
						<li class="page-item active"><a class="page-link"
							href="<c:url value='/noticeboard/list${pager.searchCondition.getQueryString(i)}'/>">${i}</a></li>
					</c:when>
					<c:otherwise>
						<li class="page-item"><a class="page-link"
							href="<c:url value='/noticeboard/list${pager.searchCondition.getQueryString(i)}'/>">${i}</a></li>
			...
			<c:choose>
				<c:when test="${pager.endPage != pager.totalPage}">
					<li class="page-item"><a class="page-link"
						href="<c:url value='/noticeboard/list${pager.searchCondition.getQueryString(pager.endPage+1)}'/>"><i
