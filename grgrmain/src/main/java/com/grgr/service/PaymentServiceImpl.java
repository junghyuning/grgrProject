...
import com.grgr.dao.PaymentDAO;
...
public class PaymentServiceImpl implements PaymentService {
	...
	//결재 확인 및 결재 취소를 위해 필요한 토큰을 제공받아 반환하는 메소드
		...
		public String getAccessToken(Payment payment) {
			...
			String data="{\"imp_key\":\"8882868580718224\", \"imp_secret\":\"fvK39IL22PzlQcWlHM2jdL4rcynZL23c73LqU3gQxxvhOuHdF3GoDXywJKLp8FZnZzcRQzrVCGO815Hu\"}";
			try {
